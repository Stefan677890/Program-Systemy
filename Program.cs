Console.WriteLine("Witaj w systemie przetwarzania systemów liczbowych");
...
switch (wybor)
{
    ...
    case 3:
        ...
        break;
    case 4:
        Console.WriteLine("Podaj liczbę w systemie szesnatkowym");
    ...
    case 6:
        ...
        Console.WriteLine(OctToDec(Console.ReadLine()));
        break;
    case 7:
